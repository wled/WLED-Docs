...
- Server-side access is limited to authorized project maintainers; application logs are configured not to retain personal identifiers such as IP addresses.
...
## 20. Disclaimer
This template is provided for convenience and does not constitute legal advice. You are responsible for ensuring compliance when modifying or redistributing WLED or integrating it into products.
