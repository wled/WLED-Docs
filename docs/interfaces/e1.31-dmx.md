...
!!! tip "Pixel Grouping"
    The same segment **Grouping** option described for `Multiple RGB` applies here. Set Grouping to `N` to treat each group of N consecutive pixels as a single DMX channel (4 channels per group: R, G, B, W).
...
!!! tip "Pixel Grouping"
    The same segment **Grouping** option described for `Multiple RGB` applies here. Set Grouping to `N` to treat each group of N consecutive pixels as a single DMX channel.
